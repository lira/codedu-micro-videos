...
trait TestSaves
{
    protected function assertStore(array $sendData, array $testDatabase, array $testJsonData = null) : TestResponse
    {
        ...
        $this->assertResponseContentJson($response, $testDatabase, $testJsonData);
        return $response;
    }
    ...
    private function assertResponseContentJson(TestResponse $response, array $testDatabase, array $testJsonData = null)
    {
